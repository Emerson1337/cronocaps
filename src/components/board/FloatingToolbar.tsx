  ...
  const toolbarItems = (
    <>
      ...
      <button
        ...
        disabled={!canUndo}
        className={cn(
          "flex items-center justify-center w-full min-w-10 h-10 rounded-lg transition-colors cursor-pointer",
          canUndo
      ...
      <button
        ...
        className={cn(
          "flex items-center justify-center min-w-10 w-full h-10 rounded-lg transition-colors cursor-pointer",
          showRoomsSummary
      ...
      <Link
        ...
        className="flex items-center justify-center w-full min-w-10 h-10 rounded-lg text-text-secondary hover:text-text-primary hover:bg-surface transition-colors"
    ...
    >
      ...
      <div className="sm:hidden">
        <button
          ...
          className={cn(
            "flex items-center justify-center w-full min-w-10 h-10 rounded-xl border border-border bg-surface-card/80 backdrop-blur-sm shadow-lg transition-colors cursor-pointer",
            mobileOpen
              ? "text-primary bg-primary/10"
